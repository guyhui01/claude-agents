...
- [`../dev-typescript-ia/SKILL.md`](../dev-typescript-ia/SKILL.md) — developer skills (consumers of the docs)
- [`../prompt-engineer/system-prompt-design.md`](../prompt-engineer/system-prompt-design.md) — prompt/agent documentation
