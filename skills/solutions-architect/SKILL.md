...
description: Enterprise solutions architecture — TOGAF ADM, ArchiMate 3 modeling, business/data/application/technology (BDAT) architecture, IS urbanization, integration patterns, cloud migration, architecture governance (ARB) and IS transformation roadmaps. Use when designing or governing enterprise-wide IT architecture.
---
