...
## See also
- [`../pim-expert/syndication-canaux.md`](../pim-expert/syndication-canaux.md) — product distribution to channels
- [`../dam-expert/integration-dam-cms.md`](../dam-expert/integration-dam-cms.md) — DAM view of CMS integration
