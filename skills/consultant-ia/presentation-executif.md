...
- [`../chef-projet-ia/reporting-codir.md`](../chef-projet-ia/reporting-codir.md) — recurring executive-committee reporting (delivery tracking)
- [`../redacteur-ia/storytelling-ia.md`](../redacteur-ia/storytelling-ia.md) — storytelling and narration
- [`../ux-design/storytelling-stakeholders.md`](../ux-design/storytelling-stakeholders.md) — stakeholder pitch and storytelling
