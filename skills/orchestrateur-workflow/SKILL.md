---
name: orchestrateur-workflow
description: Agentic workflow orchestration — workflow design and catalog, agent routing, context handoff, dependency mapping, parallel orchestration, output validation, error recovery, triggers and automation, monitoring, MCP orchestration, Claude API integration and LangGraph/CrewAI patterns. Use when chaining several agents into a workflow or designing a multi-agent pipeline.
---
