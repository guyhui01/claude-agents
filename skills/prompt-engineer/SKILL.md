...
description: Prompt engineering — system prompt design, few-shot learning, chain-of-thought, RAG prompt design, multimodal prompting, prompt evaluation, LLM evals and observability, and cost/latency optimization. Use when writing, debugging, evaluating or optimizing prompts for an LLM application.
---
