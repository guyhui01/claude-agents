---
name: data-scientist
description: Data science — exploratory analysis, statistical testing, feature engineering, supervised/unsupervised ML, deep learning, classic NLP, time series, model evaluation, A/B experimentation, MLflow tracking, bias and ethics, data visualization and data science reports. Use when framing, building or evaluating a predictive model or an analysis.
---
...
- **PyTorch**: https://pytorch.org/ (cf. dev-python-ia)
