---
name: formateur-ia
description: AI training and learning design — training needs analysis, curriculum and certification-path design, facilitation, e-learning and rapid learning, training evaluation, data literacy, AI awareness, prompt engineering, AI agents and Claude Code training. Use when designing or delivering an AI training program.
---
