...
## See also
- `skills/rh-ia/detection-fraude-cv-profils.md` — detecting keyword stuffing / AI-generated CVs
- `skills/rh-ia/recrutement-sourcing-it.md` — human qualification after scoring
- `skills/rh-ia/transformation-rh-ia.md` — ethics framework and AI ATS compliance
- `skills/juridique-ia/` — AI Act / GDPR / non-discrimination compliance
