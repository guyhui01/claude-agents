...
## See also
- `skills/rh-ia/recrutement-sourcing-it.md` — pipeline and sourcing (source of hire)
- `skills/rh-ia/transformation-rh-ia.md` — recruitment automation and ROI
- `skills/rh-ia/benchmark-remuneration-it.md` — compensation reference points
- `skills/juridique-ia/` — GDPR compliance for HR data processing
