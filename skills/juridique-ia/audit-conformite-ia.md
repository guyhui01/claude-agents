...
- [`../critique-conformite/audit-qualite-catalogue.md`](../critique-conformite/audit-qualite-catalogue.md) — methodological quality audit (ISO 19011 applied to skills)
- [`../securite-ia/`](../securite-ia/) — AI technical security audit (in-depth OWASP LLM)
