---
name: mlops-engineer
description: MLOps — MLflow tracking, feature stores and pipelines, CI/CD for ML, Docker and Kubernetes for AI, cloud deployment, model serving, inference optimization, Terraform for AI and LLM/model monitoring and drift. Use when taking a model to production or operating it reliably.
---
