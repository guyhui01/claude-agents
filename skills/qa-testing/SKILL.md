---
name: qa-testing
description: QA and testing, shared by Agile and V-model QA — test strategy and plans, BDD/Gherkin, ATDD, test cases, test pyramid and automation, integration/system/UAT tests, regression in CI/CD, exploratory, performance, security and AI testing, defect management, quality metrics and reporting. Use when planning, designing or reporting on software testing.
---
