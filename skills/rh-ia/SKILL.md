---
name: rh-ia
description: AI-era HR and IT talent acquisition — IT sourcing, job postings, technical candidate evaluation, CV parsing and ATS scoring, CV and deepfake-interview fraud detection, reference checks, IT compensation benchmarks, workforce and skills planning (GEPP), people analytics and AI HR transformation. Use when recruiting tech/AI profiles or transforming HR with AI.
---
