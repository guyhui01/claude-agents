---
name: critique-conformite
description: Control and challenge of AI deliverables — methodology compliance audits (SAFe, Scrum, ISTQB, PMI), reasoning challenge, deliverable validation gates and catalog skill quality audits against a standalone rubric. Use when reviewing an AI-produced deliverable before it ships, or auditing a skill or method for compliance.
---
