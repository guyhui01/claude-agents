...
- [`../prompt-engineer/system-prompt-design.md`](../prompt-engineer/system-prompt-design.md) — frame an agent's behavior
- [`../prompt-engineer/chain-of-thought.md`](../prompt-engineer/chain-of-thought.md) — structured reasoning
