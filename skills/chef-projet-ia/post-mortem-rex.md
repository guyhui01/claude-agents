...
- [`../scrum-master/`](../scrum-master/) — Agile retrospectives (complement to the project REX)
- [`../mlops-engineer/`](../mlops-engineer/) — ML technical incidents (drift, OOM, model rollback)
