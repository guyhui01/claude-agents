...
- [`../orchestrateur-workflow/claude-api-integration.md`](../orchestrateur-workflow/claude-api-integration.md) — caching/batch on the SDK side
- [`../dev-typescript-ia/integration-apis-llm-ts.md`](../dev-typescript-ia/integration-apis-llm-ts.md) — prompt caching implementation
