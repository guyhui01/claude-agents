...
- [`../prompt-engineer/few-shot-learning.md`](../prompt-engineer/few-shot-learning.md) — few-shot in depth
- [`../prompt-engineer/chain-of-thought.md`](../prompt-engineer/chain-of-thought.md) — CoT in depth
- [`../redacteur-ia/prompt-engineering-redaction.md`](../redacteur-ia/prompt-engineering-redaction.md) — prompts for writing
