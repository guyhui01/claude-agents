...
## See also
- `skills/rh-ia/people-analytics.md` — skills and retention indicators
- `skills/rh-ia/benchmark-remuneration-it.md` — valuing career-progression paths
- `skills/formateur-ia/` — designing upskilling paths
- `skills/consultant-ia/` — maturity diagnosis and skills roadmap
