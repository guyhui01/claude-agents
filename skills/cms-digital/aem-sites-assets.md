...
- ❌ **Customizing AEM Assets DAM off-standard** (non-IPTC/XMP metadata): lost interop (see dam-expert)
...
- [`../dam-expert/integration-dam-cms.md`](../dam-expert/integration-dam-cms.md) — AEM Assets ↔ Sites integration
