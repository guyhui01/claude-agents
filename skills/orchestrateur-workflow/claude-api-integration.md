...
- Models: **`claude-opus-5-5`** (reasoning) · **`claude-sonnet-5`** (runtime, 1M context)
...
- [`../prompt-engineer/prompt-optimization.md`](../prompt-engineer/prompt-optimization.md) — caching, batch, model selection
