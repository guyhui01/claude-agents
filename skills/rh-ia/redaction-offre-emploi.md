...
## See also
- `skills/rh-ia/benchmark-remuneration-it.md` — setting the pay range
- `skills/rh-ia/recrutement-sourcing-it.md` — distribution and sourcing
- `skills/rh-ia/cv-parsing-ats-scoring.md` — making the posting ATS-readable
- `skills/redacteur-ia/` — writing quality and employer storytelling
