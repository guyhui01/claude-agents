---
name: data-engineer
description: Data engineering — ETL/ELT ingestion pipelines, advanced SQL, dbt transformations, Airflow orchestration, Spark big data, Kafka streaming, data warehouses and lakehouses, cloud data platforms, API data integration, data quality and data governance. Use when designing or building data pipelines or a data platform.
---
