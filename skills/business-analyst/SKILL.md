...
description: Business analysis (MOA/AMOA) — requirements elicitation, business workshops, BPMN process modeling, IS mapping, functional specifications, requirements management, impact analysis, business UAT and project reporting. Use when scoping a project, eliciting or specifying requirements, modeling processes, or running business acceptance.
---
