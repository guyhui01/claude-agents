...
## See also
- `skills/rh-ia/evaluation-profils-techniques.md` — in-depth qualification after sourcing
- `skills/rh-ia/redaction-offre-emploi.md` — posting/brief to distribute
- `skills/rh-ia/benchmark-remuneration-it.md` — ranges for day-rate/salary qualification
- `skills/rh-ia/cv-parsing-ats-scoring.md` — upstream ATS scoring
