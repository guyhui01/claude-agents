...
- DCA — Docker Certified Associate (Docker)
- AWS DevOps Engineer Professional — DOP-C02 (Amazon)
- AWS Solutions Architect Associate (Amazon)
- Google Professional DevOps Engineer (Google)
...
| Provisionner l'infrastructure avec Terraform | `skills\devops_cloud\terraform-iac.md` | HashiCorp Terraform · AWS SA |
