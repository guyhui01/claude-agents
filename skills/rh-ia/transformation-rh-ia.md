...
## See also
- `skills/rh-ia/cv-parsing-ats-scoring.md` — ATS scoring (AI Act high-risk)
- `skills/rh-ia/people-analytics.md` — HR KPIs and dashboards
- `skills/juridique-ia/` — GDPR / AI Act / non-discrimination compliance
- `skills/formateur-ia/` — upskilling HR teams on AI
