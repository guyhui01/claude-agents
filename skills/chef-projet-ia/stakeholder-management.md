...
- [`../change-manager/`](../change-manager/) — in-depth change management (PROSCI/Kotter)
- [`../scrum/stakeholder-map.md`](../scrum/stakeholder-map.md) — mapping on the product side
- [`../juridique-ia/politique-ia-entreprise.md`](../juridique-ia/politique-ia-entreprise.md) — AI adoption & Works Council
