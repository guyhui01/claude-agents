---
name: dev-python-ia
description: Python AI development — advanced Python, LLM API integration, LangChain/LangGraph, RAG pipelines, vector databases, Python agents, Hugging Face Transformers, PyTorch and PEFT fine-tuning. Use when writing Python code for an LLM application, a RAG system, an agent or a model fine-tune.
---
