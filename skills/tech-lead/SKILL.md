---
name: tech-lead
description: Tech lead practices — code review, application architecture, API design, test strategy, CI/CD pipelines, branching and release, application security, performance, technical debt, technical documentation, AI-assisted dev workflows and team mentoring. Use when leading a development team's technical decisions and quality.
---
