...
## See also
- `skills/rh-ia/redaction-offre-emploi.md` — stating the range in the job posting (2023/970)
- `skills/rh-ia/recrutement-sourcing-it.md` — candidate negotiation talking points
- `skills/rh-ia/people-analytics.md` — Cost per Hire tracking
- `skills/juridique-ia/` — pay-transparency & non-discrimination compliance
