...
## See also
- `skills/rh-ia/verification-references-background-check.md` — formal background verification
- `skills/rh-ia/detection-deepfake-entretien.md` — remote-interview fraud
- `skills/rh-ia/cv-parsing-ats-scoring.md` — keyword stuffing and ATS scoring
- `skills/juridique-ia/` — GDPR framework and non-discrimination
