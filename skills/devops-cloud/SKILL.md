---
name: devops-cloud
description: DevOps and cloud — CI/CD with GitHub Actions, Docker, Kubernetes in production, Terraform IaC, AWS/Azure/GCP architecture, observability and SRE, DevOps security, FinOps and LLM incident response. Use when designing cloud infrastructure, a delivery pipeline, or production operations.
---
