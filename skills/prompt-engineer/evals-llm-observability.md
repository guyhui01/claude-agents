...
- [`../orchestrateur-workflow/workflow-monitoring.md`](../orchestrateur-workflow/workflow-monitoring.md) — workflow monitoring
- [`../ai-architect/evaluation-llm.md`](../ai-architect/evaluation-llm.md) — evaluation on the AI architecture side
