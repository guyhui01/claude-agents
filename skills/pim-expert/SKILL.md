---
name: pim-expert
description: Product information management — catalog modeling, product data onboarding and enrichment, quality scoring, catalog KPIs, localization, channel syndication, ERP-to-PIM integration, supplier portals, product data governance (MDM), PIM migration and AI-augmented PIM. Use when designing, migrating or governing a PIM or product catalog.
---
