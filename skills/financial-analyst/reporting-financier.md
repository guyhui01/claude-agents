...
- [`../chef-projet-ia/evm-valeur-acquise.md`](../chef-projet-ia/evm-valeur-acquise.md) — detailed EVM (PM view)
- [`../chef-projet-ia/reporting-codir.md`](../chef-projet-ia/reporting-codir.md) — project reporting (PM view)
