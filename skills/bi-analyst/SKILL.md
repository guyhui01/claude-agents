---
name: bi-analyst
description: Business intelligence analysis — dimensional modeling, analytical SQL, KPI catalogs, dashboards in Power BI/Microsoft Fabric, Tableau and Looker (LookML), self-service BI, BI governance, alerting and executive reporting. Use when designing a data model or dashboard, defining KPIs, writing analytical SQL, or setting up BI governance.
---
