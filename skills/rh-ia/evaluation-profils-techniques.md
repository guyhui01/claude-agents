...
## See also
- `skills/rh-ia/recrutement-sourcing-it.md` — upstream qualification
- `skills/rh-ia/detection-deepfake-entretien.md` — remote-interview authenticity
- `skills/rh-ia/verification-references-background-check.md` — background confirmation
- `skills/rh-ia/cv-parsing-ats-scoring.md` — ATS pre-selection
