---
name: scrum
description: Scrum Product Owner — product vision, backlog management, user stories (including AI and technical stories), story mapping, prioritization (MoSCoW, RICE, Kano), DoR/DoD, acceptance tests, forecasting, EBM product metrics, customer discovery, lean UX, stakeholder mapping and negotiation, risk management and PO reporting. Use when working as a Product Owner in Scrum.
---
