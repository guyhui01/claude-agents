---
name: dev-drupal
description: Drupal PHP development — custom Drupal 10 modules, Twig theming, CMI YAML configuration, REST APIs, third-party API integration, users and roles, Drupal Commerce catalog and checkout, performance, and PHPUnit/Behat tests. Use when building, extending or debugging a Drupal site or module.
---
