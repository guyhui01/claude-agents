...
- [`../cms-digital/accessibilite-numerique.md`](../cms-digital/accessibilite-numerique.md) — template accessibility (aria, contrast)
- [`../cms-digital/performance-web.md`](../cms-digital/performance-web.md) — Core Web Vitals on the render side
