...
- [`../chef-projet-ia/cadrage-projet-ia.md`](../chef-projet-ia/cadrage-projet-ia.md) — project scoping (charter, business case) if industrialized
- [`../scrum/gestion-risques.md`](../scrum/gestion-risques.md) — risk register (AI Risk Register, NIST AI RMF)
- [`../juridique-ia/ai-act-conformite.md`](../juridique-ia/ai-act-conformite.md) — AI Act risk classification of the use case
