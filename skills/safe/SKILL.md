---
name: safe
description: SAFe Product Owner — PI Planning, PI objectives, program backlog, features and capabilities, epic and feature splitting, WSJF, economic framework, Lean business cases, portfolio epics, value streams, solution trains, system demos, IP sprints, Inspect & Adapt, SAFe DevOps, metrics and OKRs. Use when working as a Product Owner inside SAFe.
---
