---
name: dev-typescript-ia
description: TypeScript AI development — advanced TypeScript, LLM API integration, Vercel AI SDK, Next.js AI apps, streaming chat UIs, frontend tool use, React AI patterns, Edge Functions and MCP server development. Use when building a TypeScript/Next.js AI application, a streaming chat interface or an MCP server.
---
