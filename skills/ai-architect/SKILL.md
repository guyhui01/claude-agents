---
name: ai-architect
description: AI solution architecture — agentic design patterns (ReAct, routing, supervisor, reflection), multi-agent topologies, MCP/A2A interoperability, RAG pipelines, LLM/agent evaluation, secure-by-design, and AI stack/cloud selection. Use when designing or reviewing an AI system's architecture, choosing frameworks or a cloud provider, or evaluating an LLM, a RAG pipeline or an agent.
---
