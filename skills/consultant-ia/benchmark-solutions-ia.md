...
- [`../business-analyst/cadrage-projet.md`](../business-analyst/cadrage-projet.md) — Build/Buy/SaaS/Lease tree + Business Case (see benchmark upstream scoping)
- [`../business-analyst/pilotage-projet.md`](../business-analyst/pilotage-projet.md) — steering the implementation program post-benchmark
