...
✅ CHANTIER CLOS (2026-09-25) — packaging Agent Skills (https://agentskills.io/specification).
  ...
  ✅ Vitrine `guyhui-showcase` — FAIT en v1.31.0 (2026-09-25, vérifié en prod) : « Catalog currently at »
  → v5.0.0 aux deux endroits (relevés figés des runs live intacts), 37 noms de dossiers en kebab-case,
  et une phrase sur le format Agent Skills adossée à la release v5.0.0.
  ...
  ABANDONNÉE : elle ne pouvait plus révéler qu'un lien de tiers, que nous ne pourrions pas réparer.
